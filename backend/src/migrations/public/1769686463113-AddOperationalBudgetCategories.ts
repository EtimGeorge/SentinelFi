...
export class AddOperationalBudgetCategories1769686463113 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "budget_category" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "tenant_id" uuid, "name" character varying(255) NOT NULL, "description" text, "type" "public"."budget_category_type_enum" NOT NULL DEFAULT 'OPEX', "is_system_default" boolean NOT NULL DEFAULT false, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_af6f95ccfa1f460edca6b488803" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_bb70ecb18a4e9dd18e5631cc31" ON "budget_category" ("tenant_id", "name") `);
        await queryRunner.query(`ALTER TABLE "tenants" ADD "max_users" integer NOT NULL DEFAULT '10'`);
        await queryRunner.query(`ALTER TABLE "tenants" ADD "max_storage_gb" integer NOT NULL DEFAULT '50'`);
        await queryRunner.query(`ALTER TABLE "tenants" ADD "expires_at" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "tenants" ADD "price" numeric(10,2) NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "settings" ADD "auditRetentionDays" integer NOT NULL DEFAULT '90'`);
        await queryRunner.query(`ALTER TABLE "settings" ADD "sessionTimeoutMinutes" integer NOT NULL DEFAULT '60'`);
        await queryRunner.query(`ALTER TABLE "settings" ADD "enableGlobalMfa" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "settings" ADD "sendgridApiKey" character varying`);
        await queryRunner.query(`ALTER TABLE "settings" ADD "erpProvider" character varying`);
        await queryRunner.query(`ALTER TABLE "settings" ADD "erpApiKey" character varying`);
        await queryRunner.query(`ALTER TABLE "settings" ADD "erpBaseUrl" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "live_expense" ADD CONSTRAINT "FK_042e8c47b849de4fe13e5f3a34f" FOREIGN KEY ("wbs_id") REFERENCES "wbs_budget"("wbs_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "live_expense" ADD CONSTRAINT "FK_000bafb36cabbe367711de78051" FOREIGN KEY ("category_id") REFERENCES "wbs_category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "wbs_budget" ADD CONSTRAINT "FK_f0d1d068032b7cba4c31f4cc469" FOREIGN KEY ("project_id") REFERENCES "project"("project_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "wbs_budget" ADD CONSTRAINT "FK_9ee635d5455ae8d76ff250a91e1" FOREIGN KEY ("parent_wbs_id") REFERENCES "wbs_budget"("wbs_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "wbs_budget" ADD CONSTRAINT "FK_49d6f917dacfd0b762dfac5117f" FOREIGN KEY ("category_id") REFERENCES "wbs_category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "wbs_budget" ADD CONSTRAINT "FK_d012c91b9b1ee791bcf10783712" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "project" ADD CONSTRAINT "FK_3a12db4eff19efee3d056a5e665" FOREIGN KEY ("created_by_user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "project_inflow" ADD CONSTRAINT "FK_5bb846d8998501d61b4d03102d5" FOREIGN KEY ("project_id") REFERENCES "project"("project_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "project_inflow" ADD CONSTRAINT "FK_ff9a8acc12a306491a2e68ffde9" FOREIGN KEY ("received_by_user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "project_audit" ADD CONSTRAINT "FK_8621cfa8010257f3cb17f730dff" FOREIGN KEY ("project_id") REFERENCES "project"("project_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "project_audit" ADD CONSTRAINT "FK_07a101eb62ca0e20269b4eb338f" FOREIGN KEY ("performed_by_user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "lpo" ADD CONSTRAINT "FK_8b20d6ab5a308ae969716de9280" FOREIGN KEY ("project_id") REFERENCES "project"("project_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "lpo" ADD CONSTRAINT "FK_cd7c77679c19877f77b22d433f3" FOREIGN KEY ("wbs_id") REFERENCES "wbs_budget"("wbs_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "lpo" ADD CONSTRAINT "FK_d303c886165202b23a4a55b4eb2" FOREIGN KEY ("created_by_user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "operational_budget_period_allocation" ADD CONSTRAINT "FK_cc263ff85608e7b23b07b8679ff" FOREIGN KEY ("operational_budget_category_id") REFERENCES "operational_budget_category"("operational_budget_category_id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "operational_budget_category" ADD CONSTRAINT "FK_ac963ad15d212a782b1989f41af" FOREIGN KEY ("operational_budget_id") REFERENCES "operational_budget"("operational_budget_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "operational_budget" ADD CONSTRAINT "FK_61fdf2278ad28f4509d6064c0a7" FOREIGN KEY ("created_by_user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payroll_entry" ADD CONSTRAINT "FK_d7fc1d2b36c496da7d2df943e73" FOREIGN KEY ("operational_budget_id") REFERENCES "operational_budget"("operational_budget_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payroll_entry" ADD CONSTRAINT "FK_cdf0ff76929b82f8fc1535f2866" FOREIGN KEY ("processed_by_user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "payroll_entry" DROP CONSTRAINT "FK_cdf0ff76929b82f8fc1535f2866"`);
        await queryRunner.query(`ALTER TABLE "payroll_entry" DROP CONSTRAINT "FK_d7fc1d2b36c496da7d2df943e73"`);
        await queryRunner.query(`ALTER TABLE "operational_budget" DROP CONSTRAINT "FK_61fdf2278ad28f4509d6064c0a7"`);
        await queryRunner.query(`ALTER TABLE "operational_budget_category" DROP CONSTRAINT "FK_ac963ad15d212a782b1989f41af"`);
        await queryRunner.query(`ALTER TABLE "operational_budget_period_allocation" DROP CONSTRAINT "FK_cc263ff85608e7b23b07b8679ff"`);
        await queryRunner.query(`ALTER TABLE "operational_expense" DROP CONSTRAINT "FK_824e9f75611b5c39b7eba8c1a50"`);
        await queryRunner.query(`ALTER TABLE "lpo" DROP CONSTRAINT "FK_d303c886165202b23a4a55b4eb2"`);
        await queryRunner.query(`ALTER TABLE "lpo" DROP CONSTRAINT "FK_cd7c77679c19877f77b22d433f3"`);
        await queryRunner.query(`ALTER TABLE "lpo" DROP CONSTRAINT "FK_8b20d6ab5a308ae969716de9280"`);
        await queryRunner.query(`ALTER TABLE "project_audit" DROP CONSTRAINT "FK_07a101eb62ca0e20269b4eb338f"`);
        await queryRunner.query(`ALTER TABLE "project_audit" DROP CONSTRAINT "FK_8621cfa8010257f3cb17f730dff"`);
        await queryRunner.query(`ALTER TABLE "project_inflow" DROP CONSTRAINT "FK_ff9a8acc12a306491a2e68ffde9"`);
        await queryRunner.query(`ALTER TABLE "project_inflow" DROP CONSTRAINT "FK_5bb846d8998501d61b4d03102d5"`);
        await queryRunner.query(`ALTER TABLE "project" DROP CONSTRAINT "FK_3a12db4eff19efee3d056a5e665"`);
        await queryRunner.query(`ALTER TABLE "wbs_budget" DROP CONSTRAINT "FK_d012c91b9b1ee791bcf10783712"`);
        await queryRunner.query(`ALTER TABLE "wbs_budget" DROP CONSTRAINT "FK_49d6f917dacfd0b762dfac5117f"`);
        await queryRunner.query(`ALTER TABLE "wbs_budget" DROP CONSTRAINT "FK_9ee635d5455ae8d76ff250a91e1"`);
        await queryRunner.query(`ALTER TABLE "wbs_budget" DROP CONSTRAINT "FK_f0d1d068032b7cba4c31f4cc469"`);
        await queryRunner.query(`ALTER TABLE "live_expense" DROP CONSTRAINT "FK_000bafb36cabbe367711de78051"`);
        await queryRunner.query(`ALTER TABLE "live_expense" DROP CONSTRAINT "FK_042e8c47b849de4fe13e5f3a34f"`);
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "password_hash"`);
        ...
        await queryRunner.query(`ALTER TABLE "settings" DROP COLUMN "sendgridApiKey"`);
        await queryRunner.query(`ALTER TABLE "settings" DROP COLUMN "enableGlobalMfa"`);
        await queryRunner.query(`ALTER TABLE "settings" DROP COLUMN "sessionTimeoutMinutes"`);
        await queryRunner.query(`ALTER TABLE "settings" DROP COLUMN "auditRetentionDays"`);
        ...
        await queryRunner.query(`ALTER TABLE "tenants" DROP COLUMN "max_storage_gb"`);
        ...
        await queryRunner.query(`DROP TABLE "operational_budget_period_allocation"`);
