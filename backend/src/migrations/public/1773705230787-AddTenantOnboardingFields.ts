...
export class AddTenantOnboardingFields1773705230787 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "tenant_settings" DROP CONSTRAINT "FK_tenant_settings_tenant_id"`,
    );
    await queryRunner.query(`DROP INDEX "public"."IDX_user_email_is_active"`);
    await queryRunner.query(
      `CREATE TABLE "conversation_member" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "conversation_id" uuid NOT NULL, "user_id" uuid NOT NULL, "last_read_at" TIMESTAMP WITH TIME ZONE, "joined_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_ed07d3bc360f4e68836841b8358" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b31b403f2e9c21a4a48460b8ed" ON "conversation_member" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_1ebe869c785ab3616b58b55d2e" ON "conversation_member" ("conversation_id", "user_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_77726325cecc7bc5d2442a7466" ON "conversation" ("tenant_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."invitations_role_enum" AS ENUM('SuperAdmin', 'CEO', 'CFO', 'Admin Director', 'Operational Director', 'Technical Director', 'Finance Manager', 'Admin Manager', 'Project Manager', 'Finance Officer', 'Admin Officer', 'Assigned Project User')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tenant_settings" ADD CONSTRAINT "FK_a6abc1c3ed0df635955fc852f1c" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("tenant_id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "conversation_member" ADD CONSTRAINT "FK_60a5cedcd205ed3686ad16d6311" FOREIGN KEY ("conversation_id") REFERENCES "conversation"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "conversation_member" ADD CONSTRAINT "FK_b31b403f2e9c21a4a48460b8ed9" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "document_control" ADD CONSTRAINT "FK_68877a2cb9c5db7e7dc3b79b230" FOREIGN KEY ("created_by_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD CONSTRAINT "FK_f6ac03431c311ccb8bbd7d3af18" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("tenant_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "invitations" ADD CONSTRAINT "FK_290e75d606ba89eb421b8b5ec49" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("tenant_id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "ai_report_schedule" ADD CONSTRAINT "FK_a1957a10d18ba3883f8f9035c3a" FOREIGN KEY ("created_by_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "ai_report_schedule" DROP CONSTRAINT "FK_a1957a10d18ba3883f8f9035c3a"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "document_control" DROP CONSTRAINT "FK_68877a2cb9c5db7e7dc3b79b230"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "conversation_member" DROP CONSTRAINT "FK_b31b403f2e9c21a4a48460b8ed9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "conversation_member" DROP CONSTRAINT "FK_60a5cedcd205ed3686ad16d6311"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "wbs_budget" DROP COLUMN "total_committed_lpo"`,
    );
    await queryRunner.query(`ALTER TABLE "project" DROP COLUMN "deleted_at"`);
    await queryRunner.query(`DROP TABLE "ai_report_schedule"`);
    await queryRunner.query(
      `DROP TYPE "public"."ai_report_schedule_status_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."ai_report_schedule_frequency_enum"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_93b03e05a660a62469fa0112aa"`,
    );
    await queryRunner.query(`DROP TABLE "report_schedule"`);
    await queryRunner.query(
      `DROP TYPE "public"."report_schedule_frequency_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."report_schedule_report_type_enum"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a3919965f72b26021d639422e6"`,
    );
    await queryRunner.query(`DROP TABLE "document_control"`);
    await queryRunner.query(
      `DROP TYPE "public"."document_control_report_type_enum"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c0ab99d9dfc61172871277b52f"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7fe3e887d78498d9c9813375ce"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0a80d1aa3c9395260e27c1245c"`,
    );
    await queryRunner.query(`DROP TABLE "message"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_77726325cecc7bc5d2442a7466"`,
    );
    await queryRunner.query(`DROP TABLE "conversation"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1ebe869c785ab3616b58b55d2e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b31b403f2e9c21a4a48460b8ed"`,
    );
    await queryRunner.query(`DROP TABLE "conversation_member"`);
    await queryRunner.query(
      `CREATE INDEX "IDX_user_email_is_active" ON "user" ("email", "is_active") `,
    );
    await queryRunner.query(
      `ALTER TABLE "tenant_settings" ADD CONSTRAINT "FK_tenant_settings_tenant_id" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("tenant_id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
}
