...
export class AddUsernameToUserTable1773120000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_3d79be558ff58a353061c6b1a8"`);

        // 3. Create new identity index including username
        await queryRunner.query(`CREATE INDEX "IDX_user_identity" ON "user" ("email", "username", "is_active") `);
    }
