...
export class AddReportingAndMessagingTables1773164796059 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Constraints
    await queryRunner.query(
      `ALTER TABLE "message" DROP CONSTRAINT IF EXISTS "FK_c0ab99d9dfc61172871277b52f6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "message" ADD CONSTRAINT "FK_c0ab99d9dfc61172871277b52f6" FOREIGN KEY ("sender_id") REFERENCES "public"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "document_control" DROP CONSTRAINT IF EXISTS "FK_68877a2cb9c5db7e7dc3b79b230"`,
    );
    await queryRunner.query(
      `ALTER TABLE "document_control" ADD CONSTRAINT "FK_68877a2cb9c5db7e7dc3b79b230" FOREIGN KEY ("created_by_id") REFERENCES "public"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_93b03e05a660a62469fa0112aa"`,
    );
    await queryRunner.query(`DROP TABLE IF EXISTS "report_schedule"`);
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_a3919965f72b26021d639422e6"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_c0ab99d9dfc61172871277b52f"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_0a80d1aa3c9395260e27c1245c"`,
    );
