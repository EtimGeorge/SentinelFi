...
export class InitialTenantSchemaSetup1768016698926 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "client_template"."operational_expense" ADD CONSTRAINT "FK_824e9f75611b5c39b7eba8c1a50" FOREIGN KEY ("operational_budget_category_id") REFERENCES "client_template"."operational_budget_category"("operational_budget_category_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "client_template"."operational_budget_category" ADD CONSTRAINT "FK_ac963ad15d212a782b1989f41af" FOREIGN KEY ("operational_budget_id") REFERENCES "client_template"."operational_budget"("operational_budget_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "client_template"."operational_budget_category" DROP CONSTRAINT "FK_ac963ad15d212a782b1989f41af"`);
        await queryRunner.query(`ALTER TABLE "client_template"."operational_expense" DROP CONSTRAINT "FK_824e9f75611b5c39b7eba8c1a50"`);
        ...
        await queryRunner.query(`DROP INDEX "client_template"."IDX_02d85ba5b35930e2e448d77eb3"`);
        await queryRunner.query(`DROP TABLE "client_template"."operational_budget_category"`);
        await queryRunner.query(`DROP INDEX "client_template"."IDX_0ec3e4d84a24a5d1902cde3173"`);
        await queryRunner.query(`DROP TABLE "client_template"."operational_expense"`);
        await queryRunner.query(`DROP TYPE "client_template"."operational_expense_status_enum"`);
