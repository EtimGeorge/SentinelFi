import { Controller, Get, Post, Body, Patch, Param, Delete, UseGuards, HttpCode, HttpStatus, Logger, Req } from '@nestjs/common';
...
export class ClientController {
  ...
  async create(@Body() createClientDto: CreateClientDto, @Req() req: any) {
    this.logger.log(`Creating client: "${createClientDto.name}" for tenant: ${req.user?.tenant_id}`);
