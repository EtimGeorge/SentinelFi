import { IsString, IsEmail, IsOptional, IsBoolean, IsUUID, IsNotEmpty, Length, Matches } from 'class-validator';
...
export class CreateClientDto {
  ...
  @Length(2, 200, { message: 'Client name must be between 2 and 200 characters' })
  ...
  @IsOptional()
  @IsString()
  @Matches(/^\+?[0-9\s\-()]+$/, { message: 'Invalid phone number format. Use digits, spaces, dashes, parentheses, or + symbol' })
