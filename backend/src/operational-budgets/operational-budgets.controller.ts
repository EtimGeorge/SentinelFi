...
export class OperationalBudgetsController {
  constructor(private readonly operationalBudgetsService: OperationalBudgetsService) {}
  ...
  async createOperationalBudget(
    ...
    return this.operationalBudgetsService.create(createOperationalBudgetDto, req.user.id, req.user.tenant_id);
  }
   ...
   */
  @Get()
  @Roles(Role.Admin, Role.CEO, Role.Finance, Role.OperationalHead, Role.ITHead, Role.SuperAdmin)
  @UsePipes(new ValidationPipe({ transform: true }))
  async findAllOperationalBudgets(
    ...
    return this.operationalBudgetsService.findAll(getOperationalBudgetsDto, req.user.tenant_id);
  }
  ...
  async updateOperationalBudget(
    ...
    return this.operationalBudgetsService.update(id, updateOperationalBudgetDto, req.user.tenant_id);
  }
  ...
  async exportOperationalBudgets(
    ...
    const data = await this.operationalBudgetsService.exportOperationalBudgetsToFormat(getOperationalBudgetsDto, exportFormat, req.user.tenant_id);
