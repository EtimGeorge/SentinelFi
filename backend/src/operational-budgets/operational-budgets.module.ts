  ...
  providers: [
    {
      ...
      useFactory: (dataSource: DataSource) => dataSource.getRepository(OperationalBudgetEntity),
      inject: [TENANT_DATA_SOURCE],
    },
    {
      provide: 'OPERATIONALBUDGETCATEGORY_REPOSITORY',
      useFactory: (dataSource: DataSource) => dataSource.getRepository(OperationalBudgetCategoryEntity),
      inject: [TENANT_DATA_SOURCE],
    },
    {
      provide: 'OPERATIONALEXPENSE_REPOSITORY',
      useFactory: (dataSource: DataSource) => dataSource.getRepository(OperationalExpenseEntity),
      inject: [TENANT_DATA_SOURCE],
    },
