...
export class FinanceCoreService {
  ...
  constructor(
    ...
    @InjectRepository(FiscalYearEntity) private fiscalYearRepo: Repository<FiscalYearEntity>,
    @InjectRepository(FiscalPeriodEntity) private fiscalPeriodRepo: Repository<FiscalPeriodEntity>,
    @InjectRepository(DepartmentEntity) private departmentRepo: Repository<DepartmentEntity>,
    @InjectRepository(CostCenterEntity) private costCenterRepo: Repository<CostCenterEntity>,
    @InjectRepository(AccountClassEntity) private accountClassRepo: Repository<AccountClassEntity>,
    @InjectRepository(AccountGroupEntity) private accountGroupRepo: Repository<AccountGroupEntity>,
    @InjectRepository(GLAccountEntity) private glAccountRepo: Repository<GLAccountEntity>,
    @InjectRepository(P2PRequisitionEntity) private requisitionRepo: Repository<P2PRequisitionEntity>,
    @InjectRepository(P2PPurchaseOrderEntity) private poRepo: Repository<P2PPurchaseOrderEntity>,
    @InjectRepository(P2PInvoiceEntity) private invoiceRepo: Repository<P2PInvoiceEntity>,
    @InjectRepository(BudgetLedgerEntity) private budgetLedgerRepo: Repository<BudgetLedgerEntity>,
