...
export class SettingsController {
  ...
  async updateSettings(@Body() updateSettingsDto: UpdateSettingsDto): Promise<SettingsEntity> {
  ...
  async sendTestEmail(@Body() sendTestEmailDto: SendTestEmailDto): Promise<{ message: string }> {
    ...
    return { message: `Test email successfully sent to ${sendTestEmailDto.to}.` };
  }
}
