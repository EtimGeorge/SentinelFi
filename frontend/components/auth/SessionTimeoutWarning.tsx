  ...
  return (
    <>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        {/* Modal */}
        <div className="bg-gray-800 rounded-2xl elev-lg max-w-md w-full overflow-hidden animate-in fade-in zoom-in duration-200">
          {/* Header */}
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-32 h-32 rounded-full bg-yellow-700 border-4 border-yellow-800">
                <div className="text-center">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                ...
                className="px-4 py-3 bg-brand-primary text-white rounded-lg hover:bg-brand-primary-dark transition-all font-medium elev-md hover:elev-lg"
              >
                Stay Logged In
              </button>
            </div>
