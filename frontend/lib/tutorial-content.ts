...
export const TUTORIAL_CONTENT: Record<string, PageTutorial> = {
  ...
  'dashboard': {
    pageKey: 'dashboard', title: 'Executive Dashboard', description: 'The central hub for financial oversight. Monitor real-time KPIs, project health, and variance across your entire portfolio.', icon: '📊', videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', // Placeholder
    tourSteps: [
      {
      ...
      {
        id: 'dashboard-kpi', title: 'Real-time KPIs', content: 'Track your total budget, actual spend, and commitments at a glance. Red values indicate budget overruns that require attention.', targetSelector: '[data-tour="kpi-cards"]', placement: 'bottom',
      },
      {
  ...
  'wbs': {
    pageKey: 'wbs', title: 'Work Breakdown Structure', icon: '🏗️', description: 'The foundation of project tracking. Manage hierarchical budgets, cost centers, and unit-of-measure tracking.', videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', // Placeholder
    tourSteps: [
  ...
  'reporting': {
    pageKey: 'reporting', title: 'Financial Reporting', description: 'Generate, download, and schedule financial reports across all your projects.', icon: '📋', tourSteps: [
      {
  ...
  'default': {
    pageKey: 'default', title: 'SentinelFi Platform Guide', description: 'A general guide to using the SentinelFi Financial Intelligence platform.', icon: '🛡️', tourSteps: [], sections: [
      {
