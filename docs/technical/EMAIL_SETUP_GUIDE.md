...
All settings are managed via the root `.env.prod`.
...
- **Emails Not Received**: Check the root `.env.prod` for `EMAIL_PREVIEW_ONLY=true`. If it's true, nothing will be sent.
